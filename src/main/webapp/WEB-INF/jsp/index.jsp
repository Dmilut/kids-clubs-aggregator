...
<div class="col-lg-8 col-md-8 col-sm-12">
		...
		<div class="col-lg-6 col-md-6 col-sm-6">
			<div class="content-box2 maxheight">
				...
				<p class="color1">
					...
					eiusmod tempor incididunt ut labore et dolore magna. <a href="#"
		...
		<div class="col-lg-6 col-md-6 col-sm-6">
			<div class="content-box3 maxheight">
				...
				<p class="color1">
					...
					incididunt ut labore et dolore magna. <a href="#"
						class="btn-default btn3"><span class="fa fa-caret-right"></span></a>
				</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-6">
				...
				<h3 class="color1">Lorem ipsum dolor sit amet conse ctetur
					...
					aliqua. Ut enim ad minim veniam.</h3>
				<p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed
	...
	<div class="content-box4">
		...
		<p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed
			...
			ut aliquip ex ea commodo consequat. Duis aute irure. Lorem ipsum
			dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor
